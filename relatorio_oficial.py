...
COLUNAS_RMA = [
    ...
    ("ENCAMINH.",      ["Encaminhamentos", "Atendimento Técnico / Parecer Social", "Encaminhamento"]),
    ("ESCUTA QUALIF.", ["Escuta Qualificada", "Atendimento Social (Escuta)", "Atendimento Social"]),
